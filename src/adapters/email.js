...
export const sendValidationEmail = async (to, url) => {
  ...
  const transporter = nodemailer.createTransport({
    service: "gmail",
    auth: {
      user: "crossfitneoland@gmail.com",
      pass: "neolandcrossfit", // naturally, replace both with your real credentials or an application-specific password
    },
  });
  ...
  const info = await transporter.sendMail({
    from: '"Neoland CrossFit 👻" <crossfitneoland@gmail.com>', // sender address
